 ...
 * @author Admin
 */
// filter which redirect user to the login page after session reseted
@WebFilter(filterName= "CheckSessionFilter", 
urlPatterns= "/pages/*")
public class CheckSessionFilters implements Filter {
    ...
    public CheckSessionFilters() {
    }    
    
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("CheckSessionFilters:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("CheckSessionFilters:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("CheckSessionFilters:doFilter()");
        }
	...
	// Create wrappers for the request and response objects.
       ...
       HttpSession session= wrappedRequest.getSession(false);
            ...
            wrappedResponse.sendRedirect(wrappedRequest.getContextPath()+"/errorPages/expiredSession.xhtml");
            }else{
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("CheckSessionFilters: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("CheckSessionFilters()");
        }
        StringBuffer sb = new StringBuffer("CheckSessionFilters(");
	...
	// You might, for example, wish to add a setParameter() method. To do this
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("CheckSessionFilters::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("CheckSessionFilters::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("CheckSessionFilters::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("CheckSessionFilters::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("CheckSessionFilters::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
