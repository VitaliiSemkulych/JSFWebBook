...
@WebServlet(name = "ImageProcessing", urlPatterns = {"/ImageProcessing"},asyncSupported = false)
public class ImageProcessing extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            byte[] image = searchController.getImage(bookID);
           
                    response.setContentLength(image .length);
                    out.write(image);   
            }else {
                String userID=request.getParameter("idU");
                 byte[] image = user.getImage(userID);
